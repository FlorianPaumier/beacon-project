...
use Devgeek\BeaconAdmin\Twig\Component\ToggleComponent;
...
final class ToggleComponentTest extends TestCase
{
    #[Test]
    ...
    {
        $reflection = new \ReflectionClass(ToggleComponent::class);
        $attributes = $reflection->getAttributes(AsLiveComponent::class);

        $this->assertCount(1, $attributes);
        $this->assertSame('BeaconAdmin:Toggle', $attributes[0]->newInstance()->serviceConfig()['key']);
    }

    #[Test]
    public function itUsesDefaultActionTrait(): void
    {
        $traits = (new \ReflectionClass(ToggleComponent::class))->getTraits();
    ...
    public function itHasDefaultValues(): void
    {
        ...
        $this->assertNull($component->onColor);
    }
    ...
    public function itHasRequiredLiveProps(): void
    {
        ...
        $this->assertLivePropExists('onColor');
    }

    private function assertLivePropExists(string $property): void
    {
        $reflection = new \ReflectionProperty(ToggleComponent::class, $property);
