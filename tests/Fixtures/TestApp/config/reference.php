 ...
 * }
 * @psalm-type BeaconAdminConfig = array{
 *     route_prefix?: scalar|Param|null, // URL prefix for all admin routes // Default: "/admin"
 *     title?: scalar|Param|null, // Title shown in header and <title> tag // Default: "Beacon Admin"
 *     logo?: scalar|Param|null, // Path to logo image (relative to public/, or an absolute URL) // Default: null
 *     theme?: array{
 *         primary_color?: scalar|Param|null, // Primary brand color (hex) // Default: "#2563eb"
 *         dark_mode?: bool|Param, // Enable dark mode toggle // Default: true
 *     },
 ...
 *     beacon_admin?: BeaconAdminConfig,
