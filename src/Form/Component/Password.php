...
class Password extends Component
{
    ...
    protected bool|\Closure $showToggle = false;
    ...
    public function showToggle(bool|\Closure $showToggle = true): static
    {
    ...
    public function hasShowToggle(): bool
    {
        return (bool) $this->evaluate($this->showToggle);
    }
}
